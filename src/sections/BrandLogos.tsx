...
const brands = [
  {
    ...
    name: "TN Nursery",
    Logo: NurseryLogo,
    url: "https://www.tnnursery.net/",
  },
  {
    id: 2,
    name: "TN Nursery (Tree)",
    Logo: TreeLogo,
    url: "https://www.tennesseewholesalenursery.com/",
  },
  { id: 3, name: "AEons", Logo: EonsLogo, url: "https://eons.com/" },
  {
    ...
    name: "Auria's",
    Logo: AuriasLogo,
    url: "https://auriasmalaysiankitchen.com/",
  },
  ...
  { id: 7, name: "MOIG", Logo: MoigoLogo, url: "https://mansionsonig.com/" },
  {
    ...
    name: "Radéant",
    Logo: RadeantLogo,
    url: "https://radiantroot.net/",
  },
  {
    id: 9,
    name: "Shunrai Knives",
    Logo: ShunraiLogo,
    url: "https://www.shinraiknives.com/",
  },
];
const TrustedBrandsSection: React.FC = () => (
  <section className="w-full px-4 sm:px-6 lg:px-8">
    <motion.div
      ...
      className="relative mx-auto w-full max-w-[1152px] overflow-hidden rounded-[24px] border border-white/10 min-h-[585px] px-5 py-10 sm:px-8 sm:py-12 lg:px-[58px] lg:py-[46px]"
    >
      ...
      <div className="relative z-10">
        ...
        <motion.div variants={fadeInTop} className="text-center">
          ...
          <p className="mx-auto max-w-[520px] mt-2 text-sm text-[#B9B9B9] sm:text-base">
        ...
        >
          {brands.map(({ id, Logo, url }) => (
            <motion.a
              ...
              className="gradient-border rounded-2xl p-px block group"
            >
