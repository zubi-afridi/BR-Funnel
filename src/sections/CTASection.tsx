...
const CTASection = () => (
  <section id="contact" className="w-full px-4 sm:px-6 lg:px-8 relative z-10 overflow-hidden">
    <div className="mx-auto w-full max-w-[1152px]">
      <div className="space-y-4">
        <h2 className="text-white font-semibold tracking-tight sm:text-2xl lg:text-[32px] text-xl">
          Ready to Unlock <br /><span className="text-gradient-blue">Predictable Revenue Growth?</span>
        </h2>
        <p className="mt-2 text-sm text-[#B9B9B9] sm:text-base">Let's build a retention system that works 24/7.</p>
      </div>
      <div className="flex flex-col lg:flex-row gap-10 mt-10">
        <div className="w-full lg:w-[830px] text-white">
          ...
          <div className="space-y-3 mb-4">
            {[ { icon: ClockIcon, text: "30 minutes" }, { icon: VideoIcon, text: "Web conferencing details provided upon confirmation." }].map((item, i) => (
          ...
          <div className="bg-white/4 border border-white/6 rounded-xl p-6 mb-4 text-[#D1D5DC]">
            <p className="text-[15px] mb-6">This is a 30-minute call to discuss how we can help scale your email and SMS marketing.</p>
