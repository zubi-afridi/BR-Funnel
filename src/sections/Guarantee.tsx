          ...
          >
            {features.map(({ id, title, description, Icon }) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-[#FFF] font-[Poppins] text-[17.6px] font-semibold leading-[26.4px] mb-1 group-hover:text-[#26FDFE] transition-colors duration-300">
                    {title}
                  </h3>
                  <p className="text-[#B9B9B9] font-[Poppins] text-[14px] font-normal leading-[22.8px]">
                    {description}
                  </p>
                </div>
              </motion.div>
