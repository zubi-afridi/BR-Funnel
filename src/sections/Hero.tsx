    ...
    <section className="relative z-0 pt-28 md:pt-32 lg:pt-48 overflow-hidden">
      ...
      <Container className="relative z-10 text-center">
        ...
        <motion.h1 
          ...
          className="text-3xl sm:text-4xl md:text-[45px] lg:text-[56px] font-semibold mb-6 tracking-tight leading-[1.1] text-white"
        >
        ...
        <motion.p 
          ...
          whileInView="visible"
          viewport={viewportSettings}
          className="text-base lg:text-[20px] text-[#E4E4E4] font-normal leading-[26px] md:leading-[37px] text-center mb-16 max-w-[450px] md:max-w-[550px] lg:max-w-[711px] mx-auto"
        >
        ...
        <motion.div 
          ...
          whileInView="visible"
          viewport={viewportSettings}
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-16 max-w-[700px] mx-auto justify-center items-center"
        >
          {stats.map((stat, idx) => (
            <motion.div
              key={idx}
            ...
            >
              ...
              <p className="text-[#B9B9B9] text-center text-base font-normal leading-[26px]">
                {stat.labelTop} <br className="hidden md:block" />{" "}
                {stat.labelBottom}
              </p>
            </motion.div>
          ))}
