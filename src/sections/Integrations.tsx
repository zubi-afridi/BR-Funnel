  ...
  return (
    <section className="relative z-0 overflow-hidden">
      <Container variant="section">
        <div className="rounded-3xl mx-auto sm:rounded-[39px] max-w-6xl border-[0.5px] border-white/7 bg-[linear-gradient(180deg,#111827_0%,#0F172A_100%)] p-4 sm:p-6 md:p-10 lg:p-14.5 transition-all">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 mb-16">
            {integrationsData.map((item, idx) => (
              <div key={idx} className="flex items-center gap-2 md:gap-5 duration-300 hover:bg-[#1a1f33] hover:border-white/8 hover:shadow-lg hover:shadow-black/20 group cursor-default rounded-2xl border border-white/10 bg-white/5 p-2 md:p-4 transition-transform hover:scale-[1.02]">
