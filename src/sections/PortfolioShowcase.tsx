    ...
    <section>
      <Container variant="section">
        ...
        >
          <motion.div
            variants={fadeInTop}
            className="flex justify-center mb-5 md:mb-9"
          >
            <div className="relative flex items-center gap-2 px-4 py-2 rounded-[10px]">
              <div
                className={`absolute inset-0 rounded-[10px] p-[1.5px] ${gradient} border-mask`}
              />
              <EmailIcon className="size-4" />
              <span
                className={`bg-clip-text text-transparent ${gradient} font-medium`}
              >
                Portfolio Showcase
              </span>
            </div>
          ...
          <div className="flex flex-col justify-between items-center text-center">
            <motion.h2
              variants={fadeInTop}
              className="text-xl md:text-2xl lg:text-3xl font-semibold text-white tracking-tight"
            >
            ...
            <motion.p
              variants={fadeInTop}
              className="max-w-[350px] md:max-w-[564px] text-[#B9B9B9] text-sm md:text-base mt-4"
            >
