...
const stories = [
  { category: "E-Commerce", image: revenueImg, growth: "+62%", title: "Revenue in 90 Days", desc: "Increased email revenue through segmented automation & personalized flows.", clientName: "Fashion Retailer" },
  { category: "E-Commerce", image: conversionImg, growth: "+62%", title: "Trial Conversions", desc: "Optimized onboarding sequences and nurture campaigns for B2B E-Commerce.", clientName: "Analytics Platform" },
  { category: "DTC", image: customerImg, growth: "+62%", title: "Customer LTV", desc: "Built retention system with SMS integration and post-purchase flows.", clientName: "Wellness Brand" }
];
              ...
              <div className="relative h-[220px] w-full overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <div className="growth-badge">
                    ...
                    <span className="text-sm font-semibold text-white whitespace-nowrap">{s.growth}</span>
                  </div>
                </div>
              </div>
              <div className="p-8 flex-1 flex flex-col">
                <div className="mb-5">
                  <span className="inline-block px-3 py-1.5 rounded-lg bg-[#141b2d] border border-[#1f2942] text-xs text-gray-300">{s.category}</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-3">{s.title}</h3>
                <p className="text-gray-400 text-sm mb-8 flex-1 line-clamp-3 leading-relaxed">{s.desc}</p>
                <div className="pt-5 mt-auto border-t border-[#1d253f]/50 flex items-center justify-between">
                  ...
                  <button className="flex items-center gap-2 text-xs font-semibold text-blue-400 hover:text-blue-300 transition-colors group/btn cursor-pointer">
                    View Case Study <ArrowIcon className="w-4 h-4 text-blue-400 group-hover/btn:translate-x-1 transition-transform" />
                  </button>
                </div>
              </div>
            </div>
